...
import { Camera, Copy, HardDrive, Loader2, Lock, Network, Pencil, SquareTerminal, Trash2, Workflow, X } from "lucide-react"
        ...
        <Tabs defaultValue="config" className="mt-3">
          ...
          <TabsContent value="backups" className="space-y-1.5">
            {backupsQuery.isLoading ? (
              ...
              (backupsQuery.data ?? [])
                ...
                .map((b) => (
                  <div key={b.volid} className="rounded-md border border-[var(--border)] px-3 py-2 text-sm">
          ...
          <TabsContent value="actions" className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                <Input placeholder="disk, e.g. scsi0" value={resizeDisk} onChange={(e) => setResizeDisk(e.target.value)} className="w-32" />
                <Input
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                <Input placeholder="target node name" value={migrateTarget} onChange={(e) => setMigrateTarget(e.target.value)} />
            ...
            <div className="flex gap-2 border-t border-[var(--border)] pt-4">
              <Button size="sm" variant="secondary" onClick={() => unlockGuest.mutate()}>
